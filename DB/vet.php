...
DB::insert("INSERT into `owner` (`firstname`, `surename`, `homeaddress`, `emailaddress`, `telephonenumber`, `info`) VALUES ('firstname', 'surename', 'homeaddress', 'emailaddress', 'telephonenumber', 'info')");
